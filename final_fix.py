...
new_section = '''    <section id="dich-vu" class="section light-section">
        <div class="container">
...
# There is a malformed block of leftover HTML from a bad replace. We can find it by looking for the first `<section id="dich-vu"`
# and replacing until we find `<section id="quan-tai"`, then keep `<section id="quan-tai"`.
start_idx = content.find('<section id="dich-vu"')
end_idx = content.find('    <!-- DANH MỤC QUAN TÀI -->')
